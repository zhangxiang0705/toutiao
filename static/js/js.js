...
UploadVideo.prototype = {
    ...
    insertLinkVideo: function insertLinkVideo(link) {
        ...
        editor.cmd.do('insertHTML', '<p><video src="' + link + '" style="width:100%" controls autobuffer /></p>');
    },
        // 上传视频
                    ...
                    if (xhr.readyState === 4) {
                        ...
                        if (!hooks.customInsert && result.errno != '0') {
                            ...
                            if (hooks.customInsert && typeof hooks.customInsert === 'function') {
                                ...
                                editor.cmd.do('insertHTML', '<p><video src="' + result.message + '" style="width:100%" controls autobuffer /></p>');
